...
use Payplug\Ogloba\Model\Api\PaymentRequestBuilder;

class CreatePaymentCommand implements CommandInterface
{
    /**
     * @param PaymentRequestBuilder $requestBuilder
     * @param Client $client
     * @param Ogloba $config
     * @param Logger $logger
     */
    ...
    public function execute(array $commandSubject): void
    {
        ...
        $payment->setAdditionalInformation(
            ...
            $request[PaymentRequestInterface::KEY_LIMONETIK_ORDER_ID]
        );
        $payment->setAdditionalInformation(
            OrderPaymentInterface::LIMONETIK_OPERATION_ID_KEY,
            $request[PaymentRequestInterface::KEY_LIMONETIK_OPERATION_ID]
        );
        $payment->setAdditionalInformation(
        ...
        $payment->setTransactionId($result[Client::VALIDATE_CODE]);
